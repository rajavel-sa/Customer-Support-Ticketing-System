...
public class ScheduledTasksTest {
    ...
    @Test
    void escalateTickets_shouldEscalateOldOpenTickets() {
        when(ticketRepository.findByStatusAndCreatedAtBefore(eq("OPEN"), any(LocalDateTime.class)))
        ...
        verify(ticketRepository).findByStatusAndCreatedAtBefore(eq("OPEN"), any(LocalDateTime.class));
    }

    @Test
    void escalateTickets_noTickets_shouldDoNothing() {
        when(ticketRepository.findByStatusAndCreatedAtBefore(eq("OPEN"), any(LocalDateTime.class)))
